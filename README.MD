...
- Home Assistant tested on 2022.6.7
...
- **WARNING** If using the Power Inverter or Diagnostic Sensors - stability problems may arise if your system should be not connected to the Lennox Cloud. Please review [docs/diagnostics.md](./docs/diagnostics.md) before using.
